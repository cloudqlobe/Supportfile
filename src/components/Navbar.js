...
const Navbar = () => {  
  ...
  return (  
    <>  
      ...
      {/* MOBILE MENU */}  
      <div   
        className={`fixed top-0 right-0 h-full w-80 bg-gradient-to-b from-blue-900 to-indigo-900 backdrop-blur-md shadow-2xl transform transition-transform duration-300 ease-in-out z-50 md:hidden ${  

...
const VoIPLandingHeader = () => {
  ...
  useEffect(() => {
    const sequence = async () => {
      ...
      setDialedNumber('+1 (555) 123-4567');
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
     ...
     <div className="relative z-10 max-w-7xl mx-auto px-8 py-20 mt-[-40px] ml-[50px]">
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[80vh]">

    {/* Left Side Content */}
    <div className="space-y-8 animate-slideInLeft mt-6">
      <h1 className="text-4xl md:text-5xl font-default text-white leading-tight whitespace-nowrap">
        Connect{" "}
      ...
      <div className="pt-18">
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <div className="relative h-[500px] animate-slideInRight flex items-center justify-center mt-[50px] ml-[80px]">
